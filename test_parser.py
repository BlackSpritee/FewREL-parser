from fewshot_re_kit.data_loader_agcn import get_loader, get_loader_pair, get_loader_unsupervised, get_loader_pair2, get_loader2
from fewshot_re_kit.framework import FewShotREFramework
from fewshot_re_kit.sentence_encoder_agcn import BERTSentenceEncoder
...
def main():
    ...
    parser.add_argument('--train', default='train_matric',
                        help='train file')
    parser.add_argument('--val', default='val_matric',
                        help='val file')
    parser.add_argument('--test', default='test/test_matric_input-5-1',
                        help='test file')
    ...
    parser.add_argument('--test_iter', default=625, type=int,
    ...
    parser.add_argument('--hidden_size', default=768, type=int,
                        help='hidden size')
    parser.add_argument('--load_ckpt', default="./checkpoint/N5K1/proto_parser_Layer1_768_mean_Eval_725__EvalAcc0.9136666609843572.pth.tar", #test
                        help='load ckpt')
    parser.add_argument('--save_ckpt', default="./checkpoint/N5K1/proto_parser_Layer1_768_mean_718__Eval.pth.tar",
                        help='save ckpt')
    parser.add_argument('--fp16', action='store_true',
                        help='use nvidia apex fp16')
    parser.add_argument('--only_test', action='store_true',
                        help='only test')
    parser.add_argument('--test_online', action='store_true',default=True,
    ...
    parser.add_argument('--pair',
                        help='use pair model')
    parser.add_argument('--pretrain_ckpt', default='/home/hadoop-aipnlp/dolphinfs/hdd_pool/data/baichuanyang/project/egnn/bert-base-uncased',
                        help='bert / roberta pre-trained checkpoint')
    parser.add_argument('--cat_entity_rep', default=True,action='store_true',
    ...
    parser.add_argument('--test_output', default="/home/hadoop-aipnlp/dolphinfs/hdd_pool/data/baichuanyang/project/simpleFSRE/data/test/5-1-result-725-withrelation.json",
                        help='test file')
    ...
    if opt.pair:
        ...
        train_data_loader = get_loader(opt.train, sentence_encoder,
                                       N=trainN, K=K, Q=Q, na_rate=opt.na_rate, batch_size=batch_size,max_length=opt.max_length)
        val_data_loader = get_loader(opt.val, sentence_encoder,
                                     N=N, K=K, Q=Q, na_rate=opt.na_rate, batch_size=batch_size,max_length=opt.max_length)
