from fewshot_re_kit.data_loader_2 import get_loader,get_loaderfewrel2, get_loader_pair, get_loader_unsupervised, get_loader_pair2, get_loader2
...
def main():
    ...
    parser.add_argument('--train', default='train_wiki',
                        help='train file')
    parser.add_argument('--val', default='val_wiki_2',
                        help='val file')
    ...
    if opt.pair:
        ...
        val_data_loader = get_loaderfewrel2(opt.val, sentence_encoder,
