from fewshot_re_kit.data_loader_parser import get_loader, get_loader_pair, get_loader_unsupervised, get_loader_pair2, get_loader2
from fewshot_re_kit.framework import FewShotREFramework
from fewshot_re_kit.sentence_encoder_parser import CNNSentenceEncoder, BERTSentenceEncoder, BERTPAIRSentenceEncoder, RobertaSentenceEncoder, RobertaPAIRSentenceEncoder, BERTRelationEncoder
import models
from models.proto_parser import Proto
...
def main():
    ...
    parser.add_argument('--train', default='train_wiki_parser',
            help='train file')
    parser.add_argument('--val', default='val_wiki_parser',
            help='val file')
    ...
    parser.add_argument('--load_ckpt', default=None,
           help='load ckpt')
    parser.add_argument('--save_ckpt', default="./checkpoint/N5K1/camery-ready.pth.tar",
           help='save ckpt')
