...
def main():
    ...
    parser.add_argument('--val_step', default=350, type=int,
    ...
    parser.add_argument('--load_ckpt', default=None,
                        help='load ckpt')
    parser.add_argument('--save_ckpt', default="./checkpoint/N5K1/proto_parser_Layer1_768_mean_Eval_725_worel.pth.tar",
                        help='save ckpt')
    ...
    parser.add_argument('--test_output', default="data/test/5-1-result.json",
                        help='test file')
