...
class BERTSentenceEncoder(nn.Module):
    ...
    def __init__(self, pretrain_path, max_length, cat_entity_rep=False, mask_entity=False, backend_model=None):
        ...
        self.fc=torch.nn.Linear(768*2,768)
    ...
    def tokenize_parserAndRaw(self, raw_tokens, head,tail, parser_tokens):
        ...
        indexed_tokens=parser_indexed_tokens_temp[:128]

        parser_mask_temp=parser_mask[:parser_length_tokens]
        mask=np.concatenate([parser_mask_temp,mask],axis=-1)[:128]

        pos1_in_index=min(parser_length_tokens+pos1_in_index,128)
        pos2_in_index=min(parser_length_tokens+pos2_in_index,128)
    ...
    def tokenize_demo_parser_pos(self, raw_tokens, pos_head,pos_tail, parser_tokens):
        ...
        indexed_tokens=parser_indexed_tokens.append(indexed_tokens)[:128]
